...
function mainmenu:onCreate(screen)
    ...
    --[[self.tabcontainer:addTab(R.text.common.hellor, function()
        ...
        dropdown:setItems({R.text.common.right, R.text.common.hellol})
        dropdown:setChangedListener(function(dropDown)
            self.ui:print(dropdown:getSelectedIndex())
            --self.ui:print("hello")
        end)
        table:add(dropdown)
        return table
    ...
    self.tabcontainer:addTab(R.text.common.asdf, function()
        local table = self.ui:newTable()
        local button_1 = self.ui:newTextButton(R.skin.default.button)
